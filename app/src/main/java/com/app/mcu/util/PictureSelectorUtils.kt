...
//        但如果你需要具体业务场景下的地址，请参考如上几种路径；
    ...
    fun selectCamera(
        ...
        isCut: Boolean = false,
        isZip: Boolean = false,
        onResultListener: (MutableList<LocalMedia>) -> Unit,
            ...
            .forResult(object : OnResultCallbackListener<LocalMedia> {
                override fun onResult(result: ArrayList<LocalMedia>?) {
                    if (result == null || result.size < 1) {
                        ...
                        val sdk = Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q
    ...
    fun selectGallery(
        ...
        PictureSelector.create(context)
            ...
            .setSelectionMode(if (isSingeSelection) SelectModeConfig.SINGLE else SelectModeConfig.MULTIPLE)
            .apply {
